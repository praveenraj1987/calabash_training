...
class Element
  ...
  def fill_date(value, *args)
    @driver.fill_date(value, interpolate_locators_with_params(*args))
  end
  ...
  def get_webview_text_from_textbox(*locator_params)
    @driver.get_webview_text_from_textbox(interpolate_locators_with_params(*locator_params))
  end
  ...
  def web_view_text_all(*args)
    @driver.web_view_text_all(interpolate_locators_with_params(*args))
  end
  ...
  def wait_for_loading_alert_view_to_go
    @driver.wait_for_loading_alert_view_to_go
  end
